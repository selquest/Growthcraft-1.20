...
public class GrowthcraftApiaryBlockRenders {
    ...
    private static void setFluidRenderLayers() {
        ItemBlockRenderTypes.setRenderLayer(GrowthcraftApiaryFluids.HONEY_MEAD_MUST.source.get(), RenderType.translucent());
        ItemBlockRenderTypes.setRenderLayer(GrowthcraftApiaryFluids.HONEY_MEAD_MUST.flowing.get(), RenderType.translucent());
